...
import com.sunxx.testng.ScreenShot;
...
public class MyAssert extends Assert {
    static final LoggerController logger = LoggerController.getLogger(MyAssert.class);
